...
; This file was generated Mon May 16 11:43:43 2011
;--------------------------------------------------------
	.module forth
	.optsdcc -mz80
...
;-------------------------------------------------------------------------------
DATA_STACK	=	0x0FD80	; Data stack grows down
VOCAB_BASE	=	0x0F000	; Dictionary grows up from here
MASS_STORE	=	0x0FEA0	; Mass storage buffer (default)
DISK_START	=	0x0A000	; Pseudo disk buffer start
DISK_END	=	0x0F000	; Pseudo disk buffer end
BLOCK_SIZE	=	0x00200	; Pseudo disk block size
BUFFERS		=	0x00001	; Pseudo disk buffers per block
MONSTART	=	0x00000	; Monitor entry address

SYSTEM		= 0x0FE00		; SYSTEM VARIABLES
S0		= 0x0FE06		; Initial value of Data SP
R0		= 0x0FE08		; Initial value of Return SP
TIB		= 0x0FE0A		; Terminal Input Buffer
WIDTH		= 0x0FE0C		; Number of letters saved in names
WARNING		= 0x0FE0E		; Error message control number
FENCE		= 0x0FE10		; Dictionary FORGET
DP		= 0x0FE12		; Dictionary Pointer
VOC_LINK	= 0x0FE14		; Most recently created vocabulary
BLK		= 0x0FE16		; Current block number interpretation
TOIN		= 0x0FE18		; Offset in the current input text buffer
OUT		= 0x0FE1A		; Offset in the current output text buff
SCR		= 0x0FE1C		; Screen number last ref'd by LIST
OFFSET		= 0x0FE1E		; Block offset for disk drives
CONTEXT		= 0x0FE20		; Pointer to vocabulary within which
					;  dictionary search will first begin
CURRENT		= 0x0FE22		; Pointer to the vocabulary within which
					;  new definitions are to be created
STATE		= 0x0FE24		; Contains state of compilation
BASE		= 0x0FE26		; Current I/O Base Address
DPL		= 0x0FE28		; Number of digits to the right of the
					;  decimal point on double integer input
FLD		= 0x0FE2A		; Field width for formatted number output
CSP		= 0x0FE2C		; Check SP
RHASH		= 0x0FE2E		; Location of editor cursor in a txt blk
HLD		= 0x0FE30		; Address of current output
FLAST		= 0x0FE32		; FORTH vocabulary data initialized
ELAST		= 0x0FE38		; Editor vocabulary data
CRFLAG		= 0x0FE3E		; Carriage Return flag
PAT		= 0x0FE40		; I/O port fetch routine INPUT
PST		= 0x0FE43		; I/O port store routine OUTPUT
RPP		= 0x0FE46		; Return SP
USE		= 0x0FE48		; Mass storage buffer address to use
PREV		= 0x0FE4A		; Mass storage buffer address just used
INTFLAG		= 0x0FE4C		; Interrupt flag and user byte following
INTVECT		= 0x0FE4E		; Interrupt vector
UTERMNL		= 0x0FE50		; Code field address of word ?TERMINAL
UKEY		= 0x0FE52		; Code field address of word KEY
UEMIT		= 0x0FE54		; Code field address of word EMIT
UCR		= 0x0FE56		; Code field address of word CR
URW		= 0x0FE58		; Code field address of word R/W
UABORT		= 0x0FE5A		; Code field address of word ABORT
UCL		= 0x0FE5C		; Number of chars per input line
UFIRST		= 0x0FE5E		; Start of pseudo disk buffer
ULIMIT		= 0x0FE60		; End of pseudo disk buffer
UBBUF		= 0x0FE62		; Number of bytes per block
UBSCR		= 0x0FE64		; Number of buffers per block
KEYBUF		= 0x0FE66		; Double key buffer
RAF		= 0x0FE68		; Register AF
RBC		= 0x0FE6A		; Register BC
RDE		= 0x0FE6C		; Register DE
RHL		= 0x0FE6E		; Register HL
RIX		= 0x0FE70		; Register IX
RIY		= 0x0FE72		; Register IY
RAF2		= 0x0FE74		; Register AF'
RBC2		= 0x0FE76		; Register BC'
RDE2		= 0x0FE78		; Register DE'
RHL2		= 0x0FE7A		; Regisetr HL'
JPCODE		= 0x0FE7D		; JP code ($C3) for word
JPVECT		= 0x0FE7E		; JP vector
;------------------------------------------------------------------------------
	.end
