        .title bdosb01.s  derived from  bdosb01.asm
...
ENDFIL	=	1		;FILL FULL BDOS LENGTH
;
...
BIOS	=	BIOSO		;BIOS ORIGIN
;
BOOT	=	BIOS          ;(BOOT) Cold boot entry
WBOOT	=     BIOS+3        ;Warm boot entry
CONST	=     BIOS+6        ;Console status
CONIN	=     BIOS+9        ;Console char in
CONOUT	=     BIOS+12       ;Console char out
LIST	=     BIOS+15       ;List char out
PUNCH	=     BIOS+18       ;Punch char out
READER	=     BIOS+21       ;Reader char in
HOME	=     BIOS+24       ;Home disk
SELDSK	=     BIOS+27       ;Select disk
SETTRK	=     BIOS+30       ;Set disk track addr
SETSEC	=     BIOS+33       ;Set disk sector addr
SETDMA	=     BIOS+36       ;Set DMA buffer addr
READ	=     BIOS+39       ;Read sector
WRITE	=     BIOS+42       ;Write sector
SECTRN	=     BIOS+48       ;Sector translation routine
;
;dwg;	.IF	ENDFIL
;dwg;	.ORG	BDOSO+0DFFH
;dwg;	.DB	55H
