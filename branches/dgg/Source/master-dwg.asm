...
MSG0:	.DB 		SCROLL,QUIT,NO_ENHANCEMENT,FAST,BELL,CR,LF,LF
	.TEXT 		"Z80 ROM MONITOR V4.7C (RomWBW Version 1 Nov 2012)  $"
...
;	.DB	0EAH				;Enable, Transmit 8 bits, Set RTS,DTR, Enable
	.DB	0AAH			; enable transmit 7 bits rts/dtr enable
;
...
;
SERIAL_OUT:	XOR	A		;Will try 256 times, then timeout
MODXXX:	PUSH	AF
