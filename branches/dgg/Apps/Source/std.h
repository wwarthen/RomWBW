/* std.h 6/1/2012 dwg - c version of std.asm */
...
#define VPNONE		0		/* NO VDU                                       */
#define VPVDU		1		/* ORIGINAL ECB VDU (6545 CHIP)                 */
#define VPVDUC		2	    /* ECB VDU COLOR (PENDING HARDWARE DEVELOPMENT) */
#define VPPROPIO	3		/* ECB PROPIO (NOT IMPLEMENTED)                 */
#define VPN8		4	    /* N8 ONBOARD VIDEO SUBSYSTEM (NOT IMPLEMENTED) */

#define CLRNEV  0			/* never clear ram disk         */
#define CLRAUTO 1			/* clear if invalid dir entries */
#define CLRALLW 2			/* always clear ram disk        */

#define	FDM720	0	/* 3.5" FLOPPY, 720KB,  2 SIDES, 80 TRKS,  9 SECTORS */
#define	FDM144	1	/* 3.5" FLOPPY, 1.44MB, 2 SIDES, 80 TRKS, 18 SECTORS */
#define	FDM360	2	/* 5.25" FLOPPY, 360KB, 2 SIDES, 40 TRKS,  9 SECTORS */
#define	FDM120	3	/* 3.5" FLOPPY, 1.2MB,  2 SIDES, 80 TRKS, 15 SECTORS */
