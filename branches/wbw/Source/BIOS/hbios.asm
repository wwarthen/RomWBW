...
#IF ((PLATFORM == PLT_N8) | (PLATFORM == PLT_MK4))
	; THIS IS RIDICULOUS, BUT WILL HAVE TO DO FOR NOW
	; CPU SPEED DETECTION MUST ASSUME A FIXED CONFIG
	; FOR XTAL MULTIPLIER AND WAIT STATES, SO HERE
	; WE FORCE MULTIPLIER AND WAIT STATES BACK TO
	; DEFAULTS PRIOR TO CALLING CPUSPD
...
;
#IF (Z180_CLKDIV >= 1)
	; DOUBLE FOR FULL XTAL SPEED
	SLA	L
	RL	H
#ENDIF

#IF (Z180_CLKDIV >= 2)
	; DOUBLE FOR X2 XTAL SPEED
	SLA	L
	RL	H
#ENDIF
;
