...
#ELSE
	...
	LD	A,1		; FLAG FOR BOOT VDA
	LD	(HCB +HCB_BOOTVDA),A	; SAVE IT
...
CIOEMU:
	LD	A,(CURVDA)
	CP	VDADEV_NONE
	JR	Z,CIOCON		; USE CONSOLE IF NO VDA DEVICE ACTIVE
	LD	A,B
