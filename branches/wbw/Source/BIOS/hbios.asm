...
#ENDIF
#IF (IDECNT >= 3)
	DEVENT(DIODEV_IDE,2)		; IDE2: (IDE SECONDARY SLAVE DISK)
#ENDIF
#IF (IDECNT >= 4)
	DEVENT(DIODEV_IDE,3)		; IDE3: (IDE SECONDARY SLAVE DISK)
#ENDIF
#ENDIF
...
#ENDIF
#IF (HDSKCNT >= 3)
	DEVENT(DIODEV_HDSK,2)		; HDSK1: (SIMH DISK DRIVE 2)
#ENDIF
#IF (HDSKCNT >= 4)
	DEVENT(DIODEV_HDSK,3)		; HDSK1: (SIMH DISK DRIVE 3)
#ENDIF
#ENDIF	
...
;
;STR_BANNER	.DB	"SBC HBIOS v", BIOSVER, ", ", BIOSBLD, ", ", TIMESTAMP, "$"
