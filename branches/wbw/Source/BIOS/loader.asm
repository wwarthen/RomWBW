...
#ENDIF
;
HCB_CDLEND	.FILL	(HCB + HCB_CDL + 8 - $),$FF	; PAD REMAINDER OF CDL
;
...
;
HCB_PDLEND	.FILL	(HCB + HCB_PDL + 4 - $),$FF	; PAD REMAINDER OF PDL
;
...
;
HCB_VDLEND	.FILL	(HCB + HCB_VDL + 4 - $),$FF	; PAD REMAINDER OF VDL
;
...
#ENDIF	
;
HCB_DDLEND	.FILL	(HCB + HCB_DDL + 8 - $),$FF	; PAD REMAINDER OF DDL
;
		.FILL	(HCB + $100 - $),$FF	; PAD REMAINDER OF HCB
;
		.ORG	$ - P2LOC
;
;==================================================================================================
