; WW - TASM adaptation (requires wrapper!)
; WW - Globally replaced squote -> dquote for all strings
; WW - Globally updated conditional expressions to use TASM operators
; WW - Commented out all of the Z80 macros (see wrapper)
;
...
;
; WW - MOVED MACROS BELOW TO ADDINSTR'S IN WRAPPER
;
;;
;;
...
SUBFCB:
	...
	ENDIF
;
	IF	~SUBA		;IF $$$.SUB ON CURRENT DRIVE
