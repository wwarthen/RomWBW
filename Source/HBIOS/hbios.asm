...
#ENDIF
;
#IF (FPLED_ENABLE & (!FPENABLE))
	.ECHO	"*** WARNING: FPLED_ENABLE WITHOUT FPENABLE!!!\n"
	!!!	; FORCE AN ASSEMBLY ERROR
#ENDIF
;
#IF (FPSW_ENABLE & (!FPENABLE))
	.ECHO	"*** WARNING: FPSW_ENABLE WITHOUT FPENABLE!!!\n"
	!!!	; FORCE AN ASSEMBLY ERROR
#ENDIF
;
...
;
	...
	OR	A			; SET FLAGS
	JR	Z,HB_FPZ		; BAIL OUT IF NOT THERE
;
...
;
HB_DSKREAD00:
#IF (FPENABLE & FPLED_ENABLE & FPLED_DSKACT)
