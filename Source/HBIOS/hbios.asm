...
;
	...
	LD	H,(HL)			; ...
	LD	L,A			; ... INTO HL
	EX	(SP),HL			; RESTORE HL & MOVE BLOB ADR TO (SP)
...
; USE UNIT # IN C TO LOOKUP DIO_TBL ENTRY.  THE DIO_TBL
...
DIO_DISPCALL:
	...
	; SETUP TO RESTORE IY AT EXIT
	LD	IY,DIO_DISPEXIT		; PRIME STACK WITH
	PUSH	IY			; ... RETURN VECTOR

	; START WITH IY POINTING TO START OF DIO_TBL
	...
	CP	DIO_FNCNT		; COMPARE TO DIO FUNCTION COUNT IN A
	JR	NC,DIO_DISPERR		; HANDLED INVALID FUNCTION NUMBER

	; BUMP IY TO ACTUAL DIO_TBL ENTRY FOR INCOMING UNIT INDEX
