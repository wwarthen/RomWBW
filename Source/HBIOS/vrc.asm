...
;
; THE STANDARD FRONT PANEL USES IO PORT ADR 0x00 WHICH CONFLICTS WITH
; THE VRC HARDWARE.  BELOW WE DEACTIVATE THE FRONT PANEL IF IT EXISTS.
;
#IF (FPENABLE & !FP_USE_I2C)
	LD	DE,(FP_ACTIVE)
    #IF ((FPLED_IO >= $00) & (FPLED_IO <= $0F))
	; CONFLICT, DEACTIVATE FP LEDS
	LD	D,FALSE			; FP LEDS NOT ACTIVE
    #ENDIF
    #IF ((FPSW_IO >= $00) & (FPSW_IO <= $0F))
	; CONFLICT, DEACTIVATE FP SWITCHES
