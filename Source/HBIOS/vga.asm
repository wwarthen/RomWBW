...
; IF (UNCOMPRESSED & IN BANK 3) OR (8X8 FONT IN BANK 3)

#IF	(((USELZSA2 == FALSE) & (FONTS_INLINE == FALSE)) | ((FONTS_INLINE == FALSE) & (VGASIZ = V80X60)))
	PUSH	DE
	LD	D,BID_IMG2
	CALL	SYS_PEEK		; GET NEXT BYTE FROM ROM BANK 3
	LD	A,E
	POP	DE
#ELSE
