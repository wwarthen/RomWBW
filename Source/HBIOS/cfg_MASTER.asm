...
I2CPCF_MULTIMASTER	.EQU	FALSE		; ESO OFF EXCEPT DURING AN OPEN TRANSACTION (MULTI-MASTER SAFETY)
;
...
;
FPENABLE	.EQU	FALSE		; FP: MASTER ENABLE FOR FRONT PANEL
...
;
FP_USE_I2C	.EQU	FALSE		; FP: USE I2C (TCA9555 VIA I2C) INSTEAD OF BUS I/O
FP_I2CADR	.EQU	$20		; FP: I2C 7-BIT ADDRESS OF TCA9555, A0/A1/A2 LOW (FP_USE_I2C ONLY, LEDS+SWITCHES SHARE ONE CHIP)
;
...
;
SAAENABLE	.EQU	FALSE		; SAA: ENABLE SAA1099A SOUND CHIP DRIVER
SAABASE		.EQU	$FF		; SAA: SAA1099A BASE IO ADDRESS
;
