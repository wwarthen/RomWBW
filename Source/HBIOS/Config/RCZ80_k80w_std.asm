...
;
FPENABLE	.SET	TRUE		; FP: MASTER ENABLE FOR FRONT PANEL
...
;
SAAENABLE	.SET	FALSE		; SAA: ENABLE SAA1099A SOUND CHIP DRIVER
SAABASE		.SET	$FF		; SAA: SAA1099A BASE IO ADDRESS
