...
CPUOSC		.SET	3579545		; CPU OSC FREQ IN HZ
...
TMSMODE		.SET	TMSMODE_MSXMKY	; TMS: DRIVER MODE: TMSMODE_[SCG|N8|MSX|MSXKBD|MSXMKY|MBC|COLECO|DUO|NABU|MSXUKY|N8PC|MECB]
