...
I2CPCFBASE	.SET	$40		; PCF8584 BASE I/O ADDRESS
I2CPCFCLK	.SET	I2CPCFCLK_12	; PCF CLOCK BASE: I2CPCFCLK_[3|443|6|8|12]
I2CPCFTRNS	.SET	I2CPCFTRNS_90	; PCF TRANSFER SPEED: I2CPCFTRNS_[90|45|11|15]
;
I2CBITENABLE	.SET	FALSE		; ENABLE I2C BIT-BANG INTERFACE
I2CBITBASE	.SET	$20		; I2C BIT-BANG INTERFACE BASE I/O ADDRESS
;
...
;
FP_USE_I2C	.SET	FALSE		; FP: USE I2C (TCA9555 VIA I2C) INSTEAD OF BUS I/O
FP_I2CADR	.SET	$20		; FP: I2C 7-BIT ADDRESS OF TCA9555, A0/A1/A2 LOW (FP_USE_I2C ONLY, LEDS+SWITCHES SHARE ONE CHIP)
;
...
SCSITRACE	.SET	0		; SCSI: TRACE LEVEL (0=NO,1=ERRORS,2=ALL)
SCSIBASE	.SET	$58		; SCSI: BASE I/O ADDRESS OF 5380
SCSIMODE	.SET	SCSIMODE_DIRECT	; SCSI: DRIVER MODE: SCSIMODE_[DIRECT|LATCH]
