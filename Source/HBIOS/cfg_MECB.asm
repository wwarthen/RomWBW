...
;
#DEFINE PLATFORM_NAME	"MECB", " [", CONFIG, "]"	; TEXT LABEL OF THIS CONFIG IN STARTUP MESSAGES
...
;
PLATFORM	.SET	PLT_MECB	; PLT_[SBC|ZETA|ZETA2|N8|MK4|UNA|RCZ80|RCEZ80|RCZ180|EZZ80|SCZ180|GMZ180|DYNO|RCZ280|MBC|RPH|Z80RETRO|SZ180|DUO|HEATH|EPITX|MON|STDZ180|NABU|SZ80|N8PC|MECB
...
;
I2CPCFENABLE	.SET	FALSE		; ENABLE PCF8584 I2C CONTROLLER
;
I2CBITENABLE	.SET	FALSE		; ENABLE I2C BIT-BANG INTERFACE
;
...
;
FPENABLE	.SET	FALSE		; FP: MASTER ENABLE FOR FRONT PANEL
FPLED_ENABLE	.SET	FALSE		; FP: ENABLES FRONT PANEL LEDS
FPLED_IO	.SET	$C1		; FP: PORT ADDRESS FOR FP LEDS
...
FPSW_IO		.SET	$C1		; FP: PORT ADDRESS FOR FP SWITCHES
...
ACIA0BASE	.SET	$08		; ACIA 0: REGISTERS BASE ADR
ACIA0CLK	.SET	4915200		; ACIA 0: OSC FREQ IN HZ
ACIA0DIV	.SET	8		; ACIA 0: SERIAL CLOCK DIVIDER
...
TMSMODE		.SET	TMSMODE_MECB	; TMS: DRIVER MODE: TMSMODE_[SCG|N8|MSX|MSXKBD|MSXMKY|MBC|COLECO|DUO|NABU|MSXUKY|N8PC|MECB]
...
DMABASE		.SET	$04		; DMA: DMA BASE ADDRESS
