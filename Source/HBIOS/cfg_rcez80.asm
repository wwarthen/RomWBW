...
#INCLUDE "hbios.inc"
;
PLATFORM	.EQU	PLT_RCEZ80	; PLT_[SBC|ZETA|ZETA2|N8|MK4|UNA|RCZ80|RCZ180|EZZ80|RCEZ80|SCZ180|DYNO|RCZ280|MBC|RPH|Z80RETRO|S100|DUO|HEATH|MON]
CPUFAM		.EQU	CPU_EZ80	; CPU FAMILY: CPU_[Z80|Z180|Z280|EZ80]
...
EZ80TIMER	.EQU	EZ80TMR_INT	; EZ80: TIMER TICK MODEL: EZ80TMR_[INT|FIRM]
;
...
SN76489CHNOUT	.EQU	SNCHAN_LEFT	; SN: CHANNEL OUTPUTS: SNCHAN_[BOTH|LEFT|RIGHT]
