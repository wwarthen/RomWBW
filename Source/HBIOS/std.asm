...
;
; PLT_RAM_R	HOW MUCH RAM NEEDS TO BE RESERVED FOR SPECIFIC PLATFORMS
; WBW_RAM_R	HOW MUCH RAM NEEDS TO BE RESERVED FOR ROMWBW
; PLT_ROM_R	HOW MUCH ROM NEEDS TO BE RESERVED FOR SPECIFIC PLATFORMS
; WBW_ROM_R	HOW MUCH ROM NEEDS TO BE RESERVED FOR ROMWBW
;
PLT_RAM_R	.EQU	0	; 0K
PLT_ROM_R	.EQU	0	; 0K
WBW_ROM_R	.EQU	128	; 128K			; TOTAL RESERVED ROM
WBW_RAM_R	.EQU	256	; 256K			; TOTAL RESERVED RAM
