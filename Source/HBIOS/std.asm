...
SDMODE_T35ALT	.EQU	19		; S100 TRION T35 FPGA Z80 ALT PORTS
;
...
;
; I2CPCF CLOCK CHIP FREQUENCIES
;
I2CPCFCLK_3   	.EQU	$00		;  3    MHz
I2CPCFCLK_443 	.EQU	$10            ;  4.43 MHz
I2CPCFCLK_6   	.EQU	$14            ;  6    MHz
I2CPCFCLK_8   	.EQU	$18            ;  8    MHz
I2CPCFCLK_12  	.EQU	$1C            ; 12    MHz
;
; I2CPCF TRANSMISSION FREQUENCIES
;
I2CPCFTRNS_90 	.EQU	$00		; 90   KHZ
I2CPCFTRNS_45 	.EQU	$01		; 45   KHZ
I2CPCFTRNS_11 	.EQU	$02		; 11   KHZ
I2CPCFTRNS_15 	.EQU	$03		;  1.5 KHZ
;
...
CFG_TAG		.EQU	6		; DRIVER TAG STRING PTR ("UART$") (WORD)
;
; DIO DRIVER SPECIFIC OFFSETS
;
CFG_DSKADR	.EQU	8		; LBA/CHS FOR DISK DRIVERS (DWORD)
CFG_DSKCAP	.EQU	12		; DISK CAPACITY FOR DISK DRIVERS (DWORD)
;
; CIO DRIVER SPECIFIC OFFSETS
;
