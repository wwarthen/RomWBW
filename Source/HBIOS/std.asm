...
#DEFINE RET_SUCCESS	XOR A \ RET			; RETURN WITH A = 0x00
#DEFINE	RET_FAIL	OR $FF \ RET			; RETURN WITH A = 0xFF


#IF (SYSCHKENABLE)
#DEFINE CALL_SYSCHK	CALL SYSCHK
#ELSE
#DEFINE CALL_SYSCHK
#ENDIF

#DEFINE RET_ERR(err)	CALL_SYSCHK \ LD A, err \ OR A \ RET
