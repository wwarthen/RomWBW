...
I2CBIT_INITDONE:
	.DB	FALSE
;
; FIRST CALL DOES THE REAL I2CBIT_INITDEV WORK, LATER CALLS JUST RETURN THE
; STORED RESULT, LETS AN EARLY FPLEDS() CALL SITE TRIGGER INIT ON DEMAND
; WITHOUT REPEATING IT WHEN I2CBIT_INIT RUNS AT ITS NORMAL BOOT POSITION.
;
I2C_ENSURE_INIT:
	LD	A,(I2CBIT_INITDONE)
	OR	A
	JR	Z,I2C_ENSURE_INIT1
	LD	A,(I2C_FAIL_FLAG)
	OR	A
	RET
I2C_ENSURE_INIT1:
	...
	JP	I2CBIT_INITDEV			; TAIL CALL, PROPAGATES REAL A/FLAGS
;
;-----------------------------------------------------------------------------
