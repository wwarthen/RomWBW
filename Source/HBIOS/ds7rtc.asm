...
;
	...
	CALL	DS7_DETECT		; PROBE FOR HARDWARE VIA I2C ACK
	LD	A,(DS7_PRESENT)		; GET PRESENCE FLAG
	OR	A			; SET FLAGS
	JR	Z,DS7_INIT_NOACK	; HANDLE NOT PRESENT
...
DS7_DEVICE:
	...
	RET
;-----------------------------------------------------------------------------
; DETECT DS1307 PRESENCE, PROBE ONLY, NO DATA PHASE
;
; RETURNS Z/A=00 IF NOT PRESENT, NZ/A=FF IF PRESENT
; ALSO SETS DS7_PRESENT
;
DS7_DETECT:
	CALL	I2C_WAIT_FOR_BB
	JR	NZ,DS7_DETECT1		; BUS BUSY, ASSUME NOT PRESENT
;
	LD	A,DS7_WRITE		; SLAVE ADDRESS (WRITE)
	CALL	I2C_START_ADDR		; GENERATE START CONDITION
...
DS7_PRESENT	.DB	0		; NON-ZERO WHEN HARDWARE DETECTED
;
;
;--------------------------------------------------------------------------------------------------
