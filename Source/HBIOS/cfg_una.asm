...
;
PS2KENABLE	.EQU	FALSE		; PS2KBD : ENABLE PS2 KBD INTERRUPT DRIVER
PS2PORT		.EQU	$E2		; PS2KBD : VT82C42 ADDRESS
;
HWTENABLE	.EQU	FALSE		; INTERRUPT DRIVEN HARDWARE TIMER TICK
