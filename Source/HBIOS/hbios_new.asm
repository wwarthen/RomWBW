...
CB_SWITCHES	.DB	'W'		; this byte is set during init
;
;   Byte 0: (L)
...
SYS_GETSWITCH:
;	PUSH	DE
;	CALL	NVR_INIT		; FUNCTION IS NOT CORRECT WRONG !!!!!!!!!!
;	POP	DE			;
;	RET	NZ			; Configuration Failed, thus cant continue
;
	LD	A,D
	CP	NVSW_STATUS		; test if want to just get NVRAM status
...
;
	...
	CP	NVSW_RESET		; test if want to reset NVRAM
...
NVR_INIT:
	...
	CALL	HB_DISPATCH		; CALL RTC
	RET	NZ			; GET BYTE Failed; Noting to do, HCB is correct. Status =0
	;
